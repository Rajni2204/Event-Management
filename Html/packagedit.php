...
<body>
    ...
    <ul class="nav navbar-nav navbar-right ml-auto">
        ...
        <li class="nav-item"><a href="mpackage.html" class="nav-link notifications"><b>Add Another Package</b><span class="badge"></span></a></li>
      ...
      $i=0;
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              <tr>
                  ...
                  <td><a href="packageupdate.php?packid=<?php echo $row['packid'];?>"><button class="button0">Edit</a></button>
                  <a href="venuedelete.php?packid=<?php echo $row['packid'];?>"><button class="button1">delete</a></button>
