      ...
      $i=0;
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              <tr>
                  ...
                  <td><a href="venueupdate.php?venueid=<?php echo $row['venueid'];?>">Edit</a>
                  <a href="venuedelete.php?venueid=<?php echo $row['venueid'];?>">disable</a>
                  <a href="venuedelete1.php?venueid=<?php echo $row['venueid'];?>">enable</a>
