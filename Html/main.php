...
// Start the session
session_start();
$username = $_SESSION["username"] //Session variable username retrieved
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="active" href="mdetails.html">
            <!--<i
    ...
    $password = "";
    $dbname = "events";
    $connnection = new mysqli($host, $user, $password, $dbname);
    ?>
    <fieldset>
            ...
            <table align="center">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            $sql = "SELECT email FROM users1 WHERE username=$username";
                            $result = $connnection->query($sql);
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            $sql = "SELECT phone FROM users1 WHERE username=$username";
                            $result = $connnection->query($sql);
                    ...
                    <tr>
                        <td><button class="button0" type="submit">Update</button>
